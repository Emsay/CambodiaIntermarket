...
<?php
    ...
    $query = "select products.*, category.cat_name from products inner join category on products.cat_id=category.cat_id order by pro_id  LIMIT $start_from, $per_page";
