        ...
        <div class="wrap">
            ...
            <div class="col-lg-12">
                ...
                <?php
    	          ...
    	          $queries = "SELECT * from products where cat_id=3";
    	          ...
    	          //Going to first page
    	          echo "<center><a href='w_watch.php?page=1'>".'First Page'."</a> ";
    
    	          for ($i=1; $i<=$total_pages; $i++) {
    
    	          echo "<a href=w_watch.php?page=".$i."'>".$i."</a> ";
    	          };
    	          // Going to last page
    	          echo "<a href='w_watch.php?page=$total_pages'>".'Last Page'."</a></center> ";
    	        ?>
            </div>
            </div>
        </div>
