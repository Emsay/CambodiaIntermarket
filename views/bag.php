        ...
        <div class="wrap">
            ...
            <div class="col-lg-12">
                ...
                <?php
    	          ...
    	          $query = "SELECT * from products where cat_id=10";
    	          $result = mysqli_query($db, $query);
    	          ...
    	          //Going to first page
    	          echo "<center><a href='bag.php?page=1'>".'First Page'."</a> ";
    
    	          for ($i=1; $i<=$total_pages; $i++) {
    
    	          echo "<a href=bag.php?page=".$i."'>".$i."</a> ";
    	          };
    	          // Going to last page
    	          echo "<a href='bag.php?page=$total_pages'>".'Last Page'."</a></center> ";
    	        ?>
            </div>
            </div>
        </div>
